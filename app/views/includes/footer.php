<!-- ~~~ CONTACT SECTION end~~~ -->
            ...
            <div class="full-width-section__wrapper">
               <div class="full-width-section__row">
                  ...
                  <aside class="full-width-section__contact-details">
                     <p class="paragraph-title paragraph-title--contact">
                        Address
                     </p>
                     ...
                     <p class="paragraph u-txt-align-left">
                        Telephone: <a href="" class="link">1-800-1234-567</a>
                     </p>
                     <p class="paragraph u-txt-align-left">
                  ...
                  <aside class="full-width-section__photo-galery">
                     ...
                     <div class="full-width-section__photo-galery--container">
                        <a href="" class="link"
                        ><img
                        src="http://farm6.staticflickr.com/5747/30641860501_9524acf10b_q.jpg"
                        alt=""
                        class="thumbnail"
                        /></a>
                        <a href="" class="link"
      ...
      <section class="footer">
         <p class="paragraph">Oildiscovery &copy; 2018</p>
      </section>
      <!-- ~~~ FOOTER end ~~~ -->
