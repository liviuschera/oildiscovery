            ...
            <div class="card__details-wrapper card__details-wrapper--full-width-blogpost">
               <span class="card__author">
                  <svg class="card__icon-post">
                     <use href="<?php echo URLROOT; ?>/images/sprite.svg#icon-user">
                     </use>
                  </svg>
                  By:
...
$data['post']->lName; ?> </a>
               ...
               <span class="card__date">
                  <svg class="card__icon-post">
                     <use href="<?php echo URLROOT; ?>/images/sprite.svg#icon-calendar">
                     </use>
                  </svg>
                  <?php echo formatDate(
    $data['post']->postCreatedAt
               ...
               <p class="paragraph u-txt-align-left">
                  <svg class="card__icon-post">
                     <use href="<?php echo URLROOT; ?>/images/sprite.svg#icon-chat">
                     </use>
                  </svg>
...
: 0; ?></a>
    ...
    'post'
      ...
      <div class="fb-share-button" data-href="<?php echo URLROOT; ?>/posts/show/<?php echo $data['post']->postID; ?>/"
         data-layout="button_count" data-size="large">
         <a target="_blank" href="<?php echo URLROOT; ?>/posts/show/<?php echo $data['post']->postID; ?>"
