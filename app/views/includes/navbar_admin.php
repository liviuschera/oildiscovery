      ...
      <nav class="sidebar">
         <ul class="side-nav">
            <li class="side-nav__item">
               <a class="side-nav__link side-nav__link--active" href="<?php echo URLROOT; ?>/posts">Go to
                  Blog
               </a>
            </li>
            <li class="side-nav__item">
               <a class="side-nav__link " href="<?php echo URLROOT; ?>/pages/add">Add
                  Menu/Page</a>
            </li>
            <li class="side-nav__item">
            ...
            <li class="side-nav__item">
               <a class="side-nav__link" href="<?php echo URLROOT; ?>/users/search">Search
                  users</a>
            </li>
            <li class="side-nav__item">
               <a class="side-nav__link" href="<?php echo URLROOT; ?>/users/register">Register
                  user</a>
            </li>
         </ul>
