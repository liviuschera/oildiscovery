...
<!-- ~~~ EDIT FORM start ~~~ -->
<form action="<?php echo URLROOT; ?>/users/edit/<?php echo $data['id']; ?>" class="form u-div-center u-txt-align-center"
    ...
    <div class="form__row">
        <div class="form__group">
            ...
            $data['firstNameError']
               ...
               ? 'form__invalid'
               : ''; ?>" value="<?php echo $data['firstName']; ?>" placeholder="First name" name="firstName"
                   id="firstName"/>
        ...
        <div class="form__group">
            ...
            $data['lastNameError']
               ...
               ? 'form__invalid'
               : ''; ?>" value="<?php echo $data['lastName']; ?>" placeholder="Last name" name="lastName"
                   id="lastName"/>
            <span class="form__failed-feedback">
    ...
    <div class="form__row">
        <div class="form__group">
            ...
            $data['emailError']
               ...
               ? 'form__invalid'
               : ''; ?>" value="<?php echo $data['email']; ?>" placeholder="Email" name="email" id="email"/>
            <span class="form__failed-feedback">
        ...
        <div class="form__group">
            ...
            $data['phoneError']
               ...
               ? 'form__invalid'
               : ''; ?>" value="<?php echo $data['phone']; ?>" placeholder="Phone" name="phone" id="phone"/>
            <span class="form__failed-feedback">
    ...
    <div class="form__row">
        <div class="form__group">
            ...
            $data['passwError']
               ...
               ? 'form__invalid'
               : ''; ?>" value="<?php echo $data['passw']; ?>" placeholder="Password" name="passw" id="passw"/>
            <span class="form__failed-feedback">
        ...
        <div class="form__group">
            ...
            $data['confirmPasswError']
               ...
               ? 'form__invalid'
               : ''; ?>" value="<?php echo $data['confirmPassw']; ?>" placeholder="Confirm password" name="confirmPassw"
                   id="confirmPassw"/>
            <span class="form__failed-feedback">
        ...
        <div class="form__group">
            <div class="form__checkbox">
                <input type="checkbox" name="active" id="active"
                       value="<?php echo $data['active']; ?>" <?php echo $data['active'] === 'y'
                   ? 'checked'
                   : ''; ?> />
