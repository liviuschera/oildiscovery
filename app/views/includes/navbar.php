        ...
        <div class="navigation__upper-half">
            <div class="navigation__row">
                <a href="<?php echo URLROOT; ?>">
                    <!-- <img class="navigation__logo" src="<?php echo URLROOT; ?>/images/logo-134x42.png" alt="Logo of Oildiscovery website" /> -->
                    ...
                    <!-- <img class="navigation__logo" srcset="<?php echo URLROOT; ?>/images/logo-536x84.png 536w, <?php echo URLROOT; ?>/images/logo-134x42.png 134w" sizes="(max-width: 750px) 300px, (max-width: 600px) 90px" src="<?php echo URLROOT; ?>/images/logo-536x84.png" alt="Logo of Oildiscovery website" /> -->
                </a>
