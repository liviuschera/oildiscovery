...
<section class="slideshow">
   ...
   <div class="slideshow__slide fadeIn">
      ...
      <h3 class="slideshow__title h-3 topFadeOut">Enjoy a Healthy Life</h3>
      <h6 class="slideshow__text h-6 fadeIn">
         ...
         <div class="full-width-section__row">
            ...
            <figure class="card card--with-icons">
               ...
               <figcaption class="card__info">
                  <p class="paragraph">
                     Get a simple, doable tweak to your habits, that will make you a healthy, vibrant version of
                     yourself.
                  </p>
               </figcaption>
            </figure>
            ...
            <figure class="card card--with-blogpost">
               <div class="card__content">
                  ...
                  <div class="card__details-wrapper">
                     <a class="card__link bold" href=""><?php echo $post->title; ?>
                        <svg class="card__icon-post">
                           <use href="<?php echo URLROOT; ?>/images/sprite.svg#icon-camera">
                           </use>
                        </svg>
                     </a>
                     <span class="card__date"> <?php echo formatDate($post->createdAt); ?></span>
                  </div>
                  <span class="card__elipsis">&#8943;</span>
               </div>
               <figcaption class="card__info">
                  <p class="paragraph">
                     <?php echo substr($post->content, 0, 210); ?>...
                  </p>
               </figcaption>
            </figure>
            <!-- ~~~ CARD end -->
